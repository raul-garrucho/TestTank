...
namespace AC
{
    ...
    [System.Serializable]
    public class ActionCharBodyExpression : Action
    {

        public int parameterID = -1;
        public int constantID = 0;
        public AnimEngine_Mecanim editingAnimEngine;
        ...
        public AnimMethodCharMecanim methodMecanim = AnimMethodCharMecanim.ChangeParameterValue;
        public MecanimCharParameter mecanimCharParameter;
        public MecanimParameterType mecanimParameterType = MecanimParameterType.Int;

        public string bodyParameterName = "ExpressionBody";
        public string faceParameterName = "ExpressionFace";

      
        public int bodyExpressionValueParameterId = -1;


        public int faceExpressionValueParameterId = -1;

        public bool skipBodyExpressionIntro = false;
        public bool skipFaceExpressionIntro = false;

        public bool syncBodyAndFace = false;

        public override ActionCategory Category { get { return ActionCategory.RainbowHigh; } }
        public override string Title { get { return "Expression"; } }
        ...
        public override void AssignValues(List<ActionParameter> parameters)
        {
            ...
            {
                (runtimeAnimChar.GetAnimEngine() as AnimEngine_Mecanim).ActionCharExpressionAssignValues(this, parameters);
            }
        }
        ...
        public override float Run()
        {
            if (runtimeAnimChar != null)
            {
                ...
                {
                    return (runtimeAnimChar.GetAnimEngine() as AnimEngine_Mecanim).ActionCharExpressionRun(this);
                }
                else
                {
        ...
        public override void Skip()
        {
            if (runtimeAnimChar != null)
            {
                if (runtimeAnimChar.GetAnimEngine() != null)
                {
                    (runtimeAnimChar.GetAnimEngine() as AnimEngine_Mecanim).ActionCharBodyExpressionSkip(this);
                }
            }
        }
        ...
        public override void ShowGUI(List<ActionParameter> parameters)
        {
            ...
            {
                CustomGUILayout.LabelField("--- Body Expressions ---");
                editingAnimEngine.ActionCharBodyExpressionGUI(this, parameters);
                skipBodyExpressionIntro = CustomGUILayout.Toggle("Skip Expression Intro:", skipBodyExpressionIntro);

                if (!syncBodyAndFace)
                {
                    CustomGUILayout.LabelField("--- Face Expressions ---");

                    editingAnimEngine.ActionCharFaceExpressionGUI(this, parameters);
                    skipFaceExpressionIntro = CustomGUILayout.Toggle("Skip Expression Intro:", skipFaceExpressionIntro);
                }
                else
                {
                   
                    skipFaceExpressionIntro = skipBodyExpressionIntro;
                }

                CustomGUILayout.LabelField("\n");

                syncBodyAndFace = CustomGUILayout.Toggle("Sync Body and Face:", syncBodyAndFace);
        ...
        protected void ResetAnimationEngine(AnimationEngine animationEngine, string customClassName)
        {
            ...
            if (className != "" && (editingAnimEngine == null || editingAnimEngine.ToString() != className) && animationEngine is AnimationEngine.Mecanim)
            {
                editingAnimEngine = (AnimEngine_Mecanim) ScriptableObject.CreateInstance(className);
            }
        }
        ...
        public static ActionCharAnim CreateNew_SpritesUnity_PlayCustom(AC.Char characterToAnimate, string clipName, bool addDirectionalSuffix = false, int layerIndex = 0, float transitionTime = 0f, bool waitUntilFinish = true, bool returnToIdleAfter = true)
        {
            ...
            newAction.method = ActionCharAnim.AnimMethodChar.PlayCustom;
        ...
        public static ActionCharAnim CreateNew_SpritesUnity_SetStandard(AC.Char characterToAnimate, AnimStandard standardToChange, string newStandardName, AudioClip newSound = null, float newSpeed = 0f)
        {
            ActionCharAnim newAction = CreateNew<ActionCharAnim>();
            newAction.animChar = characterToAnimate;
            newAction.method = ActionCharAnim.AnimMethodChar.SetStandard;
        ...
        public static ActionCharAnim CreateNew_SpritesUnity_ResetToIdle(AC.Char characterToAnimate, bool waitForCustomAnimationToFinish = false)
        {
            ActionCharAnim newAction = CreateNew<ActionCharAnim>();
            newAction.animChar = characterToAnimate;
            newAction.method = ActionCharAnim.AnimMethodChar.ResetToIdle;
