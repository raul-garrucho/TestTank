...
namespace AC
{
	...
	{
		//CUSTOM - Reference to the name of the table used for Speech
        #region Constants
#if LocalizationIsPresent
        private string TABLE_NAME = "Speech";
#endif
		#endregion
		...
		public void ShowGUI (float maxWidth = 300f)
		{
			...
			if (lineID == speechManager.activeLineID)
			{
				...
				#if LocalizationIsPresent
				//CUSTOM - Modified to avoid overwork to designers, we force the use of Unity's Localization
