...
namespace AC
{
	...
	public class Char : MonoBehaviour, ITranslatable
	{
		...
		public Color portraitRingColor = Color.white;
		...
		public Color GetPotraitRingColor()
        {
			return portraitRingColor;
        }

		public Sprite GetPotraitSpriteByID(int id)
        {
			return expressions[id].portraitIcon.GetSprite();
        }
