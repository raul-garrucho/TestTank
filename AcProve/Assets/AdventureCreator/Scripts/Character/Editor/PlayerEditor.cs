...
namespace AC
{
	...
	public class PlayerEditor : NPCEditor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			_target.skill = (Player.CharacterSkill)EditorGUILayout.EnumPopup("Characer Skill: ", _target.skill);
			

			//CustomGUILayout.BeginVertical();

			//_target.rainbowVision = (RainbowVision)EditorGUILayout.ObjectField("Rainbow Vision", _target.rainbowVision, typeof(RainbowVision), true);
