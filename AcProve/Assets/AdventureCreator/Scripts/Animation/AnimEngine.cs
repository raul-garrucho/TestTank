...
namespace AC
{
	...
	public class AnimEngine : ScriptableObject
	{
		...
		public virtual void ActionSpeechGUI(ActionSpeechDecision action, Char speaker)
		{
			#if UNITY_EDITOR
			#endif
		}
		...
		public virtual void ActionSpeechRun(ActionSpeechDecision action)
		{ }

		public virtual void ActionSpeechSkip(ActionSpeechDecision action)
		{
			ActionSpeechRun(action);
		}
