...
namespace AC
{
	...
	public class EventManager : MonoBehaviour
	{
		...
		public delegate void Delegate_Speech_Text(Speech speech,string fullText);
		...
		//By Jordan
		public static event Delegate_Speech_Text OnUpdateDisplay;
		...
		public void Call_OnUpdateDisplay(Speech speech,string fullText)
		{
			
			if (OnUpdateDisplay != null)
			{
				OnUpdateDisplay(speech, fullText);
			}
		}
